...
//                transactions.add(payment);
        ...
        try {
            FileReader fileReader = new FileReader("./src/main/java/com/dm/transactions.txt");
...
//    }
            ...
            Transaction payment = new Transaction(date, time, description, vendor, amountOfDeposit);
            transactions.add(payment);
